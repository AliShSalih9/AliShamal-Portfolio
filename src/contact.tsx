          ...
          <div className="contact-content">
            <div className="right-contact">
              <div className="contact-message">
                <p>
                  {" "}
                  Name<div className="required">*</div>
                </p>
                <input
                  type="text"
                  name="name"
              ...
              <div className="contact-message">
                <p>
                  {" "}
                  Email<div className="required">*</div>
                </p>
                <input
                  type="email"
                  name="email"
              ...
              <div className="contact-message">
                <p>
                  {" "}
                  message<div className="required">*</div>
                </p>
                <textarea
                  name="message"
                  value={form.message}
            ...
            <div className="left-contact">
              ...
              <div className="info-contact">
                ...
                <div className="content-contact">
                  <h5>Email</h5>
                  <a href="mailto:ali.shamal.code@gmail.com?subject=Contact&body=Hello%20Ali%2C%20I%20want%20to%20message%20you">
                    ali.shamal.code@gmail.com
                  </a>
                </div>
              </div>
              <div className="info-contact">
                ...
                <div className="content-contact">
                  <h5>Phone</h5>
                  <a
                    href="https://wa.me/9647507686271?text=Hello%20Ali%20I%20want%20to%20contact%20you"
                    target="_blank"
                  >
                    +964 750 768 6271
                  </a>
              ...
              <div className="info-contact">
                ...
                <div className="content-contact">
                  ...
                  <small>
                    {" "}
                    Duhok City, Duhok Governorate, Kurdistan Region, Iraq
                  </small>
                </div>
              </div>
              <h2>Fallow Me</h2>
